...
const EXPORT_DAYBOOK_FILTER_VOUCHER_BY_LEDGER_2 =
    '<!-- ' +
    '*********************************************************************** ' +
...
const ExportDaybookFilterVoucherByLedger2 = function () {
    ExportUtil(EXPORT_DAYBOOK_FILTER_VOUCHER_BY_LEDGER_2)
}

export default ExportDaybookFilterVoucherByLedger2;